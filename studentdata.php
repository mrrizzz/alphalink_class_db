...
<body class="bg-gray-100">
  ...
  <!-- NAVBAR SECTION END -->
  <div class="container w-10/12 ml-64 mt-20 pr-12">
    <button onclick="location.href = 'create.php'" class="bg-blue-800 text-white px-2 py-1 m-1 mt-10 rounded-md flex items-center"><svg
          xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
          class="w-4 h-4 mr-1.5">
          <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15"/>
        </svg>
        Add</button>
    <table class="table-auto w-full mx-auto border mt-5 border-black-300">
      <thead>
        <tr>
